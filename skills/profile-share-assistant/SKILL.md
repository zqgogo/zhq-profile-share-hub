...
description: Use when the user wants to create or manage a shareable resume page or matchmaking/social profile through the local profile-share service, including returning public/manage URLs, recovering the fixed workers.dev entry, or using a manage URL to activate, deactivate, reset counts, or regenerate content.
---
